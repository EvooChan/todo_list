...
todoElements.render = function () {
   ...
   this.forEach(function(element, index) {
	   if (element.done == 'in progress') {code += '<div class="body">' + '<span class="eltext">' + '<input type="radio" checked onclick="todoElements.check()" id="'+index+
   ...
   else if (element.done == 'done') {code += '<div class="body">' + '<span class="eltext">' + '<input type="radio" onclick="todoElements.check()" id="'+index+
   '" name="'+index+'" class="inProgress" />' + '<label for="' + index + '"><span></span></label>' + '<input type="radio" id="'+index+1 +
