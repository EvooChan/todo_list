...
else if(radio[2].checked==true){console.log(index, ' ', index+1);todoElements.splice(index, 1); todoElements.render()};})};

todoElements.render = function () {
   this.forEach(function(element, index) {
	   
	  if (element.done == 'one') {element.code = '<div class="body">' + '<span class="eltext">' + '<input type="radio" checked onclick="todoElements.check()" id="'+index+
   ...
   else if (element.done == 'two') {element.code = '<div class="body">' + '<span class="eltext">' + '<input type="radio" onclick="todoElements.check()" id="'+index+
   '" name="'+index+'" class="left" />' + '<label for="' + index + '"><span></span></label>' + '<input type="radio" id="'+index+1 +
   ...
   element.code = '<div class="body">' + '<span class="eltext">' + '<input type="radio" id="'+index+
   ...
   ' - In progress <span class="toppic"></span> - Done <img src="checked.jpg"> - Delete</div><div class="top1">To Do List</div>' + 
